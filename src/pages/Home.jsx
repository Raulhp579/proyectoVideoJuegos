...
import { fetchPopularGamesThunk } from "../store/slices/gamesSlice";
...
export default function Home() {
  ...
  useEffect(() => {
    // Solo recargar si no hay data prev, opcional, pero mejor siempre o dependiente
    if (games.length === 0) {
      dispatch(fetchPopularGamesThunk({ page: 1, pageSize: 12 }));
    }
    ...
    <div className="mx-auto max-w-6xl px-4 py-10 flex flex-col gap-10">
      <section className="rounded-3xl border border-zinc-900 bg-gradient-to-b from-zinc-900/40 to-zinc-950 p-8">
        ...
        <p className="mt-3 text-zinc-300 max-w-2xl">
          Explora títulos populares, busca entre miles de juegos y entra al
          detalle para ver géneros, plataformas, fechas y puntuación.
        </p>
